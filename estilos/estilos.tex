...
\makeatletter
\NewDocumentCommand{\imagetest}{+O{}+m}{
	\begin{figure}[H]
		\centering
		\captionsetup{justification=centering}
		\includegraphics[width=\textwidth]{imagenes/vacia.pdf}
		\caption{Aquí debe ir una imagen sin referencia}
	\end{figure}	
}
